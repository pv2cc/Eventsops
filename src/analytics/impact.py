...
def compute_before_after(
    ...
    weekly_veh_hrs = float(prestaging_impact.get("vehicle_hours_closure_avoided", 0))
    officer_hours_weekly = round(weekly_veh_hrs * OFFICER_HOURS_PER_VEH_HR, 1)
    ...
    return {
        ...
        "officer_hours_saved_per_week": officer_hours_weekly,
